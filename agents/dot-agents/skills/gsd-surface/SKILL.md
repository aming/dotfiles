...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/aming/.config/opencode/.gsd-surface.json`
(sibling to `/home/aming/.config/opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/aming/.config/opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/aming/.config/opencode/skills`).
...
`/home/aming/.config/opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/aming/.config/opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/aming/.config/opencode/.gsd-surface.json`
Install profile marker: `/home/aming/.config/opencode/.gsd-profile`
Skill dirs: `/home/aming/.config/opencode/skills/gsd-*/`
Engine module: `/home/aming/.config/opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/aming/.config/opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
