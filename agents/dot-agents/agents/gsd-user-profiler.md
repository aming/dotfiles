...
<reference>
@/home/aming/.config/opencode/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/aming/.config/opencode/gsd-core/references/user-profiling.md` to load:
