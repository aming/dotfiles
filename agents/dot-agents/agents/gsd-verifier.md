...
<required_reading>
@/home/aming/.config/opencode/gsd-core/references/verification-overrides.md
...
@/home/aming/.config/opencode/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/home/aming/.config/opencode/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@/home/aming/.config/opencode/gsd-core/references/verify-mvp-mode.md`.
