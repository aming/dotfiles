...
Reference full template: `/home/aming/.config/opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/aming/.config/opencode/gsd-core/templates/state.md`.
